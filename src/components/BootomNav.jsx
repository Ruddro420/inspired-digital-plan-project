    ...
    <>
      <div className="btm-nav mt-20">
        <Link
          ...
          className={
            location.pathname === "/home/price"
              ...
              : "bg-[#F2F2F2] text-[black] border-[black]"
          }
        >
          <svg
        ...
        >
          ...
          <span className="btm-nav-label">Individual </span>
        </Link>

        <Link
          to="/home/corporate"
          className={
            location.pathname === "/home/corporate"
              ? "active bg-[black] text-[white] border-[black]"
              : "bg-[#F2F2F2] text-[black] border-[black]"
          }
        >
          ...
          <span className="btm-nav-label">Corporate</span>
        </Link>
        <Link
          to="/home/others"
          className={
            location.pathname === "/home/others"
              ? "active bg-[black] text-[white] border-[black]"
              : "bg-[#F2F2F2] text-[black] border-[black]"
          }
        >
